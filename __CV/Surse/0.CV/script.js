  ...
  const projects = `
                     ...
                     <table>
                       ...
                       <tr>
                        ...
                        <tr>
                          <td> <a href='https://adriana-play-bussines-card.netlify.app/' target="_blank"> Bussines Card </a> </td>
                          <td> React v6 </td>
                          <td>
                            <img src="./img/20_buisinessCard.png" alt="Bussines Card preview picture" width="100" height="150">
                        </td>
                         <td>
                            <p> User: - </p>
                            <p> Password: - </p>
                        ...
                        <tr>
                          <td> <a href='https://adriana-play-tenzies.app/' target="_blank"> Tenzies </a> </td>
                          <td> React v18 </td>
                          <td>
                            <img src="./img/21_tenzies.png" alt="Tenzies preview picture" width="100" height="100">
                        </td>
                         <td>
                            <p> User: - </p>
                            <p> Password: - </p>
