...
const runSpecs = () => {
  ...
  describe('sequelize', () => {
    ...
    describe('db/migrations folder', () => pathExists(path.join(__dirname, '..', 'db', 'migrations')));
    describe('db/models folder', () => pathExists(path.join(__dirname, '..', 'db', 'models')));
    describe('db/seeders folder', () => pathExists(path.join(__dirname, '..', 'db', 'seeders')));
  });
